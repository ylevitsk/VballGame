...
void Model::load(std::istream& is)
{
	...
	//NORMALS PER FACE
	/*for (int i = 0; i < currMesh->mFaces.size(); i++){
		glm::vec3 v1 = glm::vec3(currMesh->mModel->mVertices[currMesh->mFaces[i].V[0].mVertex - 1].x, currMesh->mModel->mVertices[currMesh->mFaces[i].V[0].mVertex - 1].y, currMesh->mModel->mVertices[currMesh->mFaces[i].V[0].mVertex - 1].z);
		glm::vec3 v2 = glm::vec3(currMesh->mModel->mVertices[currMesh->mFaces[i].V[1].mVertex - 1].x, currMesh->mModel->mVertices[currMesh->mFaces[i].V[1].mVertex - 1].y, currMesh->mModel->mVertices[currMesh->mFaces[i].V[1].mVertex - 1].z);
		glm::vec3 v3 = glm::vec3(currMesh->mModel->mVertices[currMesh->mFaces[i].V[2].mVertex - 1].x, currMesh->mModel->mVertices[currMesh->mFaces[i].V[2].mVertex - 1].y, currMesh->mModel->mVertices[currMesh->mFaces[i].V[2].mVertex - 1].z);

		glm::vec3 c = glm::cross(v2 - v1, v3 - v1);
		mNormals.push_back(c);
		currMesh->mFaces[i].V[0].mNormal = i + 1;
	}*/
}
