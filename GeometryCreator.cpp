...
Mesh2::Mesh2(std::vector<float> const & Positions, std::vector<float> const & Normals, std::vector<unsigned short> const & Indices)
    : PositionHandle(0), NormalHandle(0), IndexHandle(0), IndexBufferLength(0)
{
...
Mesh2 * GeometryCreator::CreateCube(vec3 const & Size)
{
    ...
    {
        -1.0, -0.5, -0.5, // back face verts [0-3]
        -1.0,  0.5, -0.5,
         1.0,  0.5, -0.5,
         1.0, -0.5, -0.5,
         
        -1.0, -0.5,  0.5, // front face verts [4-7]
        -1.0,  0.5,  0.5,
         1.0,  0.5,  0.45,
         1.0, -0.5,  0.5,
         
        -1.0, -0.5,  0.5, // left face verts [8-11]
        -1.0, -0.5, -0.5,
        -1.0,  0.5, -0.5,
        -1.0,  0.5,  0.5,
        
         1.0, -0.5,  0.5, // right face verts [12-15]
         1.0, -0.5, -0.5,
         1.0,  0.5, -0.5,
         1.0,  0.5,  0.5,
         
        -1.0,  0.5,  0.5, // top face verts [16-19]
        -1.0,  0.5, -0.5,
         1.0,  0.5, -0.5,
         1.0,  0.5,  0.5,
        
        -1.0, -0.5,  0.5, // bottom face verts [20-23]
        -1.0, -0.5, -0.5,
         1.0, -0.5, -0.5,
         1.0, -0.5,  0.5
    };
    ...
    return new Mesh2(Positions, Normals, Indices);
}

Mesh2 * GeometryCreator::CreateCylinder(
...
Mesh2 * GeometryCreator::CreateDisc(
...
Mesh2 * GeometryCreator::CreateSphere(glm::vec3 const & Radii, unsigned int const Slices, unsigned int const Stacks)
{
    std::vector<float> Positions, Normals;
    std::vector<unsigned short> Indices;
...
Mesh2 * GeometryCreator::CreateTorus(
    float const innerRadius, 
    float const outerRadius, 
